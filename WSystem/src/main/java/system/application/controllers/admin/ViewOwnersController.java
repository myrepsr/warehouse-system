...
public class
ViewOwnersController extends UserController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        int row = 1;
        try {
            for (int i = 0; i < wSystem.getOwners().size(); i++) {
                ...
                userController.setOwner(wSystem.getOwners().get(i));
